...
class _StatisticsScreenState extends State<StatisticsScreen>
  ...
  List<Widget> _buildRecentActivities() {
    ...
    activities.addAll([
      _buildActivityItem('إضافة شهادة جديدة', 'أحمد محمد - القدس', 'منذ ساعتين'),
      _buildActivityItem('تحديث حالة', 'فاطمة علي - غزة', 'منذ 3 ساعات'),
      _buildActivityItem('موافقة على تسجيل', 'محمد أحمد - طولكرم', 'منذ 5 ساعات'),
    ]);
