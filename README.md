# 🇵🇸 Palestine Martyrs Documentation System

نظام توثيق الشهداء والجرحى والأسرى الفلسطينيين - تطبيق موبايل مع خادم API متكامل
...
- **وضع متصل**: مزامنة فورية مع قاعدة البيانات السحابية
